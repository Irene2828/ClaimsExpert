...
export default function LegalPage() {
  ...
  return (
    <main className="bg-[#F5F6F8] min-h-screen flex flex-col selection:bg-[#0E223F] selection:text-white">
      <div className="flex-grow pt-[48px] pb-[72px] lg:pt-[64px] lg:pb-[96px] px-8 lg:px-12">
        ...
        <article className="bg-white rounded-[24px] shadow-sm border border-[#E2E8F0] p-8 md:p-12 lg:p-16 max-w-[900px] mx-auto">
