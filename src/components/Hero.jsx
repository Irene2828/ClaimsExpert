  ...
  return (
    ...
    >
      <div className="max-w-[1336px] mx-auto px-8 lg:px-12 w-full relative">
        <div className="grid lg:grid-cols-[1.08fr_0.92fr] gap-10 lg:gap-8 items-center pt-6 pb-0 lg:pt-8 lg:pb-0 relative">
          <div
            className="order-2 lg:order-1 relative z-10 flex flex-col justify-center pt-0 lg:pt-0 pb-4 lg:pb-0"
