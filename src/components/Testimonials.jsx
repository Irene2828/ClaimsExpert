    ...
    <section id="testimonials" className="bg-white border-t border-[#E5E7EB]">
      <div className="max-w-[1336px] mx-auto px-8 lg:px-12 py-24 lg:py-28 flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-[1280px] mx-auto items-stretch">
          {/* Card 1 (White Card) */}
          <div className="bg-white rounded-[24px] pt-10 px-7 sm:px-8 lg:px-9 pb-4 border border-[#0E223F]/15 min-h-[360px] flex flex-col justify-between text-left relative overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
            <div className="flex flex-col justify-between h-full w-full gap-2">
              <div className="flex items-center justify-between w-full mb-6">
                <p className="font-inter font-semibold text-[12px] tracking-[0.14em] uppercase text-[#0E223F]/70">
          ...
          <div className="bg-[#0E223F] rounded-[24px] pt-10 px-7 sm:px-8 lg:px-9 pb-4 relative overflow-hidden shadow-[0_24px_64px_rgba(14,34,63,0.14)] border border-white/15 min-h-[360px] flex flex-col justify-between text-left">
            <div
            ...
            <div className="relative flex flex-col justify-between h-full w-full z-10 gap-2">
              <div className="flex items-center justify-between w-full mb-6">
                <p className="font-inter font-semibold text-[12px] tracking-[0.14em] uppercase text-white/70">
                  Municipal Client
                </p>
              </div>
              <div className="flex-1 flex flex-col justify-between py-3 gap-6">
                <h3 className="font-inter font-bold text-[17px] lg:text-[18.5px] leading-[1.35] tracking-[-0.02em] text-white mb-5 text-left">
                  “Clear. Rigorous. Decisive.”
                </h3>
                <div className="w-full h-px bg-white/15 mb-5" />
                <div style={{ maxHeight: "180px", overflowY: "auto" }} className="testimonial-scrollbar pr-1">
                  <p className="font-inter font-normal text-[13.5px] lg:text-[14px] leading-[1.65] text-white/80 text-left">
                    “Isabelle’s direct, thorough approach to claims investigation has saved our municipality both time and resources while ensuring fair, defensible resolutions on every file.”
                  </p>
                </div>
              </div>
              <div className="testimonial-author-footer is-dark mt-auto">
                <p className="font-inter font-medium text-[12px] tracking-[0.1em] uppercase text-white/50">
                  — Municipal Risk Manager, Greater Montreal
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[24px] pt-10 px-7 sm:px-8 lg:px-9 pb-4 border border-[#0E223F]/15 min-h-[360px] flex flex-col justify-between text-left relative overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
            <div className="flex flex-col justify-between h-full w-full gap-2">
              ...
              <div className="flex-1 flex flex-col justify-between py-3 gap-6">
                <h3 className="font-inter font-bold text-[17px] lg:text-[18.5px] leading-[1.35] tracking-[-0.02em] text-[#0E223F] mb-5 text-left">
                  “Valuable technical expertise during complicated litigation”
                </h3>
                <div className="w-full h-px bg-[#0E223F]/10 mb-5" />
                <div style={{ maxHeight: "180px", overflowY: "auto" }} className="testimonial-scrollbar pr-1">
                  <p className="font-inter font-normal text-[13.5px] lg:text-[14px] leading-[1.65] text-[#0E223F]/85 text-left">
                    Isabelle’s thorough documentation and understanding of policy terms ensured an accurate and fair settlement for our property loss.
                  </p>
                </div>
              </div>
              <div className="testimonial-author-footer mt-auto">
                <p className="font-inter font-medium text-[12px] tracking-[0.1em] uppercase text-[#0E223F]/50">
