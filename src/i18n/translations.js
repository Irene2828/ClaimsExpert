export const translations = {
  en: {
    ...
    hero: {
      ...
      bodyPart1: "Independent claims adjuster specializing in ",
      bodyHighlight: "municipal civil liability, property damage, and bodily injury",
      bodyPart2: " — bringing that same expertise directly to policyholders navigating their own insurance claims.",
    ...
    approach: {
      ...
      card1Body: "Documenting evidence, photos, plans, and technical details directly for your claim.",
      card2Title: "Clear communication",
      card2Body: "Framing claims clearly for insurers and municipalities to avoid unnecessary delays.",
      card3Title: "Direct updates",
      card3Body: "Direct contact and regular updates on your file status — no call centers or automated queues.",
    },
    expertise: {
      eyebrow: "EXPERTISE",
      headline: "Technical expertise. Clear analysis. Informed decisions.",
      body1: "Independent claims expertise for municipalities and policyholders, with a focus on ",
      body2: "thorough investigation, technical analysis and fair, well-supported outcomes.",
      card1: {
    ...
    process: {
      eyebrow: "HOW I WORK",
      headline: "A clear, structured process.",
      body: "Every file begins with understanding the facts, identifying the issues, and determining the appropriate path forward.",
      step1: {
        title: "01 — Review & Assessment",
        body: "Understanding the circumstances, reviewing the available documentation, and identifying the key factual, technical, and liability issues."
      },
      step2: {
        title: "02 — Investigation & Analysis",
        body: "Gathering and organizing the relevant evidence, assessing liability, causation and damages, and identifying any additional information required for a complete analysis."
      },
      step3: {
        title: "03 — Recommendations & Resolution",
        body: "Providing a clear, well-supported assessment of the file and practical recommendations to help my client make informed decisions and move toward an appropriate resolution."
      }
    },
    testimonials: {
      eyebrow: "TESTIMONIALS",
      headline: "A track record clients trust.",
      card1Badge: "Homeowner & Policyholder",
      card1Title: "“Isabelle obtained results in one week that I was not able to get in 2.5 years.”",
    ...
    contact: {
      ...
      form: {
        ...
        emailLabel: "EMAIL",
        emailPlaceholder: "you@domain.ca",
    ...
    about: {
      ...
      timeline: {
        ...
        year2016Badge: "2016 • EXPANSION",
        year2016Text: "Isabelle Guertin joins the family practice, developing deep expertise in municipal civil liability.",
        year2026Badge: "2026 • PRESENT",
        year2026Text: "Isabelle Guertin assumes sole ownership, expanding into public adjusting services while honoring core values."
      }
    }
  },
  fr: {
    ...
    hero: {
      ...
      bodyPart1: "Experte en sinistres indépendante, spécialisée en ",
      bodyHighlight: "responsabilité civile municipale, dommages matériels et dommages corporels",
      bodyPart2: " — mettant cette même expertise directement au service des assurés qui gèrent leurs propres réclamations d'assurance.",
      bookBtn: "Prendre rendez-vous",
      howIWorkBtn: "Voir comment je travaille",
    ...
    approach: {
      ...
      card1Body: "Documentation directe des preuves, photos, plans et détails techniques pour votre réclamation.",
      card2Title: "Communication claire",
      card2Body: "Présenter les réclamations de façon claire aux assureurs et aux municipalités afin d'éviter des délais inutiles.",
      card3Title: "Mises à jour directes",
      card3Body: "Contact direct et mises à jour régulières sur l'état de votre dossier — aucun centre d'appels ni file d'attente automatisée.",
    },
    expertise: {
      eyebrow: "EXPERTISE",
      headline: "Expertise technique. Analyse claire. Décisions éclairées.",
      body1: "Expertise indépendante en sinistres pour les municipalités et les assurés, axée sur une ",
      body2: "enquête approfondie, une analyse technique et des résultats équitables et bien étayés.",
      card1: {
    ...
    process: {
      ...
      headline: "Un processus clair et structuré.",
      body: "Chaque dossier débute par la compréhension des faits, l'identification des enjeux et la détermination de la voie à suivre.",
      step1: {
        title: "01 — Examen et évaluation",
        body: "Comprendre les circonstances, examiner la documentation disponible et cerner les principaux enjeux factuels, techniques et de responsabilité."
      },
      step2: {
        title: "02 — Enquête et analyse",
        body: "Recueillir et organiser les preuves pertinentes, évaluer la responsabilité, la causalité et les dommages, et déterminer toute information additionnelle nécessaire à une analyse complète."
      },
      step3: {
        title: "03 — Recommandations et résolution",
        body: "Fournir une évaluation claire et bien étayée du dossier ainsi que des recommandations pratiques pour aider mon client à prendre des décisions éclairées et à progresser vers une résolution appropriée."
      }
    },
    testimonials: {
      eyebrow: "TÉMOIGNAGES",
    ...
    contact: {
      ...
      form: {
        ...
        emailLabel: "COURRIEL",
        emailPlaceholder: "vous@domaine.ca",
    ...
    about: {
      ...
      timeline: {
        ...
        year2016Badge: "2016 • EXPANSION",
        year2016Text: "Isabelle Guertin rejoint le cabinet familial, développant une expertise approfondie en responsabilité civile municipale.",
        year2026Badge: "2026 • PRÉSENT",
        year2026Text: "Isabelle Guertin devient l'unique propriétaire, élargissant ses services à l'expertise en sinistres au bénéfice de l'assuré tout en honorant les valeurs fondamentales."
      }
    }
  }
};
